...
exp = Experiment('no_conv_case', codebase=cb)
...
namelist_name = os.path.join(GFDL_BASE, 'exp/edited_cases/change_conv_strength/no_conv.nml')
...
# test if this actually works before running full length
